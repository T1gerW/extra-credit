...
# Define the optimized XGBoost model with CPU acceleration
xgb_model = xgb.XGBClassifier(
    ...
    tree_method='cpu_hist',        # CPU-accelerated histogram algorithm
    predictor='cpu_predictor',     # CPU for predictions
